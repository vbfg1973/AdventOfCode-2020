...
namespace AdventOfCode.Tests
{
    public class AdventOfCode_Day2Tests
    {
        ...
        public void GivenPositionalConstraintsStringMatches(int posA, int posB, char c, string testString, bool expected)
        {
            var passwordVerifier = new PasswordVerifier();
        ...
        public void GivenRuleIsParsedIntoComponents(string rule, int expectedMin, int expectedMax, char expectedChar, string expectedPassword)
        {
            var passwordVerifier = new PasswordVerifier();
